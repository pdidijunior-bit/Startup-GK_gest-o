      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredDocs.length === 0 ? (
          <div className="col-span-full p-12 text-center bg-slate-900 border border-slate-800 rounded-2xl flex flex-col items-center justify-center gap-3">
            <FileText className="w-12 h-12 text-slate-700 mb-1" />
            <h3 className="text-base font-bold text-white">Nenhum documento cadastrado</h3>
            <p className="text-xs text-slate-400 max-w-sm">
              Crie contratos digitais, briefings de projetos ou propostas comerciais da Startup GK para download offline em PDF/Doc.
            </p>
            <button
              onClick={() => setIsAddModalOpen(true)}
